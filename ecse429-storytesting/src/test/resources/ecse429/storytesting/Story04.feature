...
Feature: Remove task from course to do list
  ...
  Scenario Outline: Remove task from class
    ...
    And "assignment1" and "assignment2" are added to the class "gherkin101" todo list
    When I remove "<taskTitle>" from the class "gherkin101" todo list
