...
#    Given the application is running
  ...
  Scenario Outline: Adjust priority of a task
    ...
    When I adjust the priority of the task to "<new_priority>" and remove "<initial_priority>"
    Then the task is categorized with the "<new_priority>" and the old link to "<initial_priority>" is removed
  ...
  Scenario Outline: Adjust priority of a non existing task
    ...
    Given a non existing task with a priority "<initial_priority>"
    And a category called "<new_priority>"
